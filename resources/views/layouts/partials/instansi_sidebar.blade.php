<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main" style="height: auto;">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                {{-- Mengarahkan ke rute yang benar dan menambahkan logika 'active' --}}
                <a class="nav-link text-white {{ request()->routeIs('instansi.profile.edit') ? 'active bg-gradient-primary' : '' }}" href="{{ route('instansi.profile.edit') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-cog"></i>
                    </div>
