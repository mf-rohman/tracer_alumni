            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $alumnus->user->email) }}" readonly>
                    </div>
                </div>
                 <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="prodi_id" name="prodi_id" required>
                            ...
                            @foreach($prodi as $p)
                                <option value="{{ $p->id }}" {{ $alumnus->prodi_id == $p->id ? 'selected' : '' }}>{{ $p->nama_prodi }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
